...
/**
 * Physically deletes the stored document content file.
 * This should ONLY be used when the document status is already REJECTED.
 */
export async function deleteBlob(docId) {
  ...
  if (STORAGE_MODE === "sync") {
    try {
      ...
      // If file doesn't exist, ignore. Otherwise, rethrow.
